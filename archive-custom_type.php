							...
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article">
								...
								<header class="article-header">
									...
									<p class="byline vcard"><?php
										printf( __( 'Posted <time class="updated" datetime="%1$s" itemprop="datePublished">%2$s</time> by <span class="author">%3$s</span>', 'sepalandseedtheme' ), get_the_time( 'Y-m-j' ), get_the_time( __( 'F jS, Y', 'sepalandseedtheme' ) ), get_author_posts_url( get_the_author_meta( 'ID' ) ));
									?></p>
